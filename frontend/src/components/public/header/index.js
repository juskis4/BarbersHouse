  ...
  return (
    <div>
      <div className="header">
        ...
        <div className="info-section">
          ...
          <p>
            ...
            <a href="https://www.google.com/maps/dir/?api=1&destination=55.8718491,9.8391846" target="_blank" rel="noopener noreferrer"> Show on map</a>
          </p>
          ...
          <div className="phone-number">
            <FaPhone style={{ color: 'orange', marginRight: '5px' }} /> <span>Phone: +45 52 64 42 96</span>
          </div>
        </div>
      ...
      <button className="floating-button" onClick={handleClickOpen}>
        ...
        <span className="floating-button-text">Book Now</span>
      </button>
    </div>
  );
}
